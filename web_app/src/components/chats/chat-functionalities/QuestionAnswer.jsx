      ...
      <div class={styles.inputContainer}>
            ...
            <Switch>
              <Match when={contextTab() === "text"}>
                <div class={styles.textInputContainer}>
                  <textarea 
                    id="contextTextarea" 
                    placeholder='Enter context here. Answer will be based on the context provided.'
                  />
                </div>
              </Match>
              <Match when={contextTab() === "file"}>
                <div class={styles.fileInputContainer}>
                  ...
                  />
                  <input type="file" id="contextFileInput" accept=".txt, .html, .docx" class={styles.fileInput} />
                </div>
              </Match>
            </Switch>
          </div>
        ...
        <div class={styles.questionContainer}>
          ...
          <div class={styles.questionSection}>
            <div class={styles.questionInputContainer}>
              <textarea 
                id="questionTextarea" 
